...
# Step 2 — Initialize Supabase at root
...
change the port number in supabase/config.toml, If any port already in use by diff apps, below command autometiclly create 
```bash
supabase start
```
